# Lareisha Lewis | Data Analytics Portfolio

Welcome to my data analytics portfolio.

I hold a Master of Science in Applied Data Science and have a professional background in K–12 education, where I have used student assessment data, performance reports, spreadsheets, and student information systems to support decision making and improve student outcomes.

I am currently focused on strengthening and applying my skills in **SQL, Python, data cleaning, data analysis, and data visualization** through hands on portfolio projects.

My graduate coursework also provided experience with statistical analysis, machine learning, and R, which are represented in some of the academic projects included in this repository.
...
### Texas STAAR Performance Analytics
**Tools:** SQL, Python, PostgreSQL, Data Visualization  
**Status:** In Progress

Analyzing multi-year Texas STAAR Mathematics data across Houston area school districts to identify performance trends, student group gaps, and areas where additional support may have the greatest potential impact.

This project includes data cleaning, transformation, validation, SQL analysis, benchmarking, and visual reporting.
...
My graduate studies in Applied Data Science also included experience with:
...
[LinkedIn](https://www.linkedin.com/in/lareisha-lewis)
